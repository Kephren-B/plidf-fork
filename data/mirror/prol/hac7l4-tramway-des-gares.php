...
<head>
<meta charset="utf-8"/>
<title>Tramway des gares | Le plan Ile-de-France</title>
...
<meta content="Tramway des gares" property="og:title"/>
<meta content="http://www.plidf.fr/prol/hac7l4-tramway-des-gares.php" property="og:url"/>
<meta content="Le projet de tramway des gare est un projet de liaison par tramway des grandes gares parisiennes." name="description"/>
<meta content="Le projet de tramway des gare est un projet de liaison par tramway des grandes gares parisiennes." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="hac7l4-tramway-des-gares.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="hac7l4-tramway-des-gares.php">Tramway des gares</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\hac7l4.png" title="QRcode for http://www.plidf.fr/prol/hac7l4-tramway-des-gares.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','hac7l4');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','hac7l4');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','hac7l4');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','hac7l4');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','hac7l4');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','hac7l4');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="infobox">
...
<div>
<div>
<h1 id="top"> <img class="line-logo line-logo-network line-logo-network-t" height="25" src="..\medias\logos\logo_tram.svg" title="Tramway" width="25"/><a class="line-link" href="..\ligne\t_g.php"><img class="line-logo line-logo-line line-logo-line-t-g" height="25" src="..\medias\logos\tram_g.svg" title="Tramway des gares" width="25"/></a> Tramway des gares </h1>
<p> <em>gare-de-l'est</em> - <em>gare-de-l'est</em> </p>
<div>
<a class="section-link top-link" href="#maps-section">↓ Aller au tracé</a>
</div>
<p id="description"> </p>
<p id="line-subtitle">Création de la <a href="..\ligne\t_g.php">ligne g</a> du tramway.</p>
<p>En suivant plus ou moins l'itinéraire des bus noctiliens N01 et N02, le tramway des gares serait une ligne de tramway circulaire qui connecterait entre elles les gares de Paris.</p>
<p></p>
<p></p>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\t_gares.jpg" onclick="CommentManager.reportMap('t_gares','hac7l4')"><img src="..\medias\plans\t_gares_resized.jpg" style="max-width:450px" title="Un tracé possible pour le tramway des gares. Cliquer pour agrandir."/></a>
<figcaption>
         Un tracé possible pour le tramway des gares.
         <br/>
