...
<head>
    <meta charset="utf-8" />
    <title>Près de chez vous</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta content="website" property="og:type" />
    <meta content="Le Plan Ile-de-France" property="og:site_name" />
    <meta content="Près de chez vous" property="og:title" />
    <meta content="http://www.plidf.fr/geo.php" property="og:url" />
    <meta content="Trouvez ce qui vous interesse sur des critères géographiques" name="description" />
    <meta content="Trouvez ce qui vous interesse sur des critères géographiques" property="og:description" />
    <link href="layouts\main\css\layout.css" rel="stylesheet" />
    <link href="layouts\main\css\graphics.css" rel="stylesheet" />
    <link href="geo.php" rel="canonical" />
    ...
    <div id="all">
        ...
        <main>
            <nav id="breadcrumb">
                ...
                <a href="page\geo\index.html">Vue globale</a>
            </nav>
            <aside id="side-box">
            </aside>
            <article class="node-list-slot">
                <div>
                    <div>
                        <h1>Près de chez moi</h1>
                        <p>Le plan Ile-de-France inclus des propositions pour l'ensemble de l'Île-de-France. À l'aide de cette page trouvez ce que vous cherchez par catégorie. </p>
                    </div>
                </div>
                <div>
                    <div>
                        <h3>Index des contenus</h3>
                        <ul class="geo-index">
                            <li><a href="index\communes.php">Communes</a></li>
                            <li><a href="index\gares.php">Gares et stations</a></li>
                            <li><a href="index\lignes.php">Lignes</a></li>
                            <li><a href="index\poles.php">Poles d'attractivité</a></li>
                            <li><a href="index\prolongements.php">Projets</a></li>
                        </ul>
                    </div>
                </div>
                <div>
                    <div>
                        <h2>Cartes</h2>
                        <h3 id="geo-metro">Métro</h3>
                        <p>Carte des projets de métro pour Paris et la petite couronne.</p>
                        <figure>
                            <div style="overflow:auto;max-height:500px">
                                <img src="medias\plans\paris_metro.svg" style="width:100%;background-image:url(/medias/plans/paris_bg_resized.jpg);background-size:contain" />
                                <a href="medias\plans\paris_metro.svg">Agrandir</a>
                            </div>
                            <figcaption class="geocaption">
                                La version agrandie est cliquable et vous permettra d'aller directement sur la page du projet qui vous intéresse.
                            </figcaption>
                        </figure>
                        <h3 id="geo-rer-tangentielles" style="margin-top:2em;">RER et tangentielles</h3>
                        <p>Cartes des projets de RER et de tangentielle pour Paris et la petite couronne.</p>
                        <figure>
                            <div style="overflow:auto;max-height:500px">
                                <img src="medias\plans\paris_rer.svg" style="width:100%;background-image:url(/medias/plans/paris_bg_resized.jpg);background-size:contain" />
                                <a href="medias\plans\paris_rer.svg">Agrandir</a>
                            </div>
                        </figure>
                    </div>
                </div>
