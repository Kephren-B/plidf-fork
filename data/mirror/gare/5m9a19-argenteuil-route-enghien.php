...
<head>
<meta charset="utf-8"/>
<title>Argenteuil - Route d'Enghien (Métro) | Le plan Ile-de-France</title>
...
<meta content="Argenteuil - Route d'Enghien" property="og:title"/>
<meta content="http://www.plidf.fr/gare/5m9a19-argenteuil-route-enghien.php" property="og:url"/>
<meta content="" name="description"/>
<meta content="" property="og:description"/>
<meta content="FR-95" name="geo.region"/>
<meta content="Argenteuil - Route d'Enghien (Métro)" name="geo.placename"/>
<meta content="48.95762;2.27984" name="geo.position"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="5m9a19-argenteuil-route-enghien.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="5m9a19-argenteuil-route-enghien.php">Argenteuil - Route d'Enghien</a>
</nav>
<aside id="side-box">
<div>
...
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','5m9a19');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','5m9a19');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','5m9a19');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','5m9a19');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','5m9a19');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','5m9a19');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\5m9a19.png" title="QRcode for http://www.plidf.fr/gare/5m9a19-argenteuil-route-enghien.php"/>
<hr/>
</div>
</div>
</aside>
...
<h1>Argenteuil - Route d'Enghien<br/></h1>
<div>
...
<div id="description">
<p>La station Route d'Enghien est un projet de station du métro Nord pour desservir l'est d'Argenteuil.</p>
</div>
<div>
<figure class="station-map-figure">
<p><a href="http://www.openstreetmap.org/?mlat=48.95762&amp;mlon=2.27984&amp;zoom=15" onclick="CommentManager.seeOnOSM('5m9a19')" target="_blank">Voir l'emplacement de cette gare sur openstreetmap</a></p>
</figure>
</div>
<div>
