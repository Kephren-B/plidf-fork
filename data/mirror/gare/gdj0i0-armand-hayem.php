...
<head>
<meta charset="utf-8"/>
<title>Armand Hayem (Métro) | Le plan Ile-de-France</title>
...
<meta content="Armand Hayem" property="og:title"/>
<meta content="http://www.plidf.fr/gare/gdj0i0-armand-hayem.php" property="og:url"/>
<meta content="" name="description"/>
<meta content="" property="og:description"/>
<meta content="FR-95" name="geo.region"/>
<meta content="Armand Hayem (Métro)" name="geo.placename"/>
<meta content="49.00650;2.28367" name="geo.position"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="gdj0i0-armand-hayem.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="gdj0i0-armand-hayem.php">Armand Hayem</a>
</nav>
<aside id="side-box">
<div>
...
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','gdj0i0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','gdj0i0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','gdj0i0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','gdj0i0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','gdj0i0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','gdj0i0');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\gdj0i0.png" title="QRcode for http://www.plidf.fr/gare/gdj0i0-armand-hayem.php"/>
<hr/>
</div>
</div>
</aside>
...
<em>Communes de <span class="commune-name-span">Eaubonne</span>, <span class="commune-name-span">Margency</span>, <span class="commune-name-span">Montlignon</span> </em>
<div id="description">
<p>La station Armand Hayem est un projet de station du métro nord pour desservir Eaubonne, Montlignon, Margency et Saint-Prix.</p>
</div>
<div>
<figure class="station-map-figure">
<p><a href="http://www.openstreetmap.org/?mlat=49.00650&amp;mlon=2.28367&amp;zoom=15" onclick="CommentManager.seeOnOSM('gdj0i0')" target="_blank">Voir l'emplacement de cette gare sur openstreetmap</a></p>
</figure>
</div>
<div>
