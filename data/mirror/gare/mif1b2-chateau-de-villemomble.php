...
<head>
<meta charset="utf-8"/>
<title>Château de Villemomble (Métro) | Le plan Ile-de-France</title>
...
<meta content="Château de Villemomble" property="og:title"/>
<meta content="http://www.plidf.fr/gare/mif1b2-chateau-de-villemomble.php" property="og:url"/>
<meta content="" name="description"/>
<meta content="" property="og:description"/>
<meta content="FR-93" name="geo.region"/>
<meta content="Château de Villemomble (Métro)" name="geo.placename"/>
<meta content="48.88406;2.51064" name="geo.position"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="mif1b2-chateau-de-villemomble.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="mif1b2-chateau-de-villemomble.php">Château de Villemomble</a>
</nav>
<aside id="side-box">
<div>
...
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','mif1b2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','mif1b2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','mif1b2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','mif1b2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','mif1b2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','mif1b2');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\mif1b2.png" title="QRcode for http://www.plidf.fr/gare/mif1b2-chateau-de-villemomble.php"/>
<hr/>
</div>
</div>
</aside>
...
<h1>Château de Villemomble<br/></h1>
<div>
...
<em>Commune de Villemomble </em>
<div id="description">
<p>La station Château de Villemomble est un projet de station de métro pour desservir la commune de Villemomble. Elle serait situé sous l'emplacement de l'actuel terminus du bus 121. Elle serait un point de correspondance entre les lignes 1 et 11.</p>
</div>
<div>
<figure class="station-map-figure">
<p><a href="http://www.openstreetmap.org/?mlat=48.88406&amp;mlon=2.51064&amp;zoom=15" onclick="CommentManager.seeOnOSM('mif1b2')" target="_blank">Voir l'emplacement de cette gare sur openstreetmap</a></p>
</figure>
</div>
<div>
