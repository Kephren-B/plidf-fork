...
<head>
<meta charset="utf-8"/>
<title>Gare de Maison-Blanche | Le plan Ile-de-France</title>
...
<meta content="Maison-Blanche" property="og:title"/>
<meta content="http://www.plidf.fr/gare/aja4fg-maison-blanche.php" property="og:url"/>
<meta content="" name="description"/>
<meta content="" property="og:description"/>
<meta content="FR-75" name="geo.region"/>
<meta content="Gare de Maison-Blanche" name="geo.placename"/>
<meta content="48.82237;2.35870" name="geo.position"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="aja4fg-maison-blanche.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="aja4fg-maison-blanche.php">Maison-Blanche</a>
</nav>
<aside id="side-box">
<div>
...
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','aja4fg');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','aja4fg');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','aja4fg');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','aja4fg');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','aja4fg');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','aja4fg');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\aja4fg.png" title="QRcode for http://www.plidf.fr/gare/aja4fg-maison-blanche.php"/>
<hr/>
</div>
</div>
</aside>
...
<div id="description">
<p>La station Maison blanche est une station de la ligne 7 du métro. Le Plan Ile-de-France propose d'en faire un nouveau pôle de correspondance entre les lignes 7, 14 et la Petite Ceinture Express pour le sud de Paris.</p>
</div>
<div>
<figure class="station-map-figure">
<p><a href="http://www.openstreetmap.org/?mlat=48.82237&amp;mlon=2.35870&amp;zoom=15" onclick="CommentManager.seeOnOSM('aja4fg')" target="_blank">Voir l'emplacement de cette gare sur openstreetmap</a></p>
</figure>
</div>
<div>
