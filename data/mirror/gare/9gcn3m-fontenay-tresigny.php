...
<head>
<meta charset="utf-8"/>
<title>Gare de Fontenay-Trésigny | Le plan Ile-de-France</title>
...
<meta content="Fontenay-Trésigny" property="og:title"/>
<meta content="http://www.plidf.fr/gare/9gcn3m-fontenay-tresigny.php" property="og:url"/>
<meta content="" name="description"/>
<meta content="" property="og:description"/>
<meta content="FR-77" name="geo.region"/>
<meta content="Gare de Fontenay-Trésigny" name="geo.placename"/>
<meta content="48.70850;2.87107" name="geo.position"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="9gcn3m-fontenay-tresigny.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="9gcn3m-fontenay-tresigny.php">Fontenay-Trésigny</a>
</nav>
<aside id="side-box">
<div>
...
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','9gcn3m');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','9gcn3m');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','9gcn3m');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','9gcn3m');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','9gcn3m');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','9gcn3m');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\9gcn3m.png" title="QRcode for http://www.plidf.fr/gare/9gcn3m-fontenay-tresigny.php"/>
<hr/>
</div>
</div>
</aside>
...
<em>Commune de <span class="commune-name-span">Fontenay-Trésigny</span> </em>
<div id="description">
<p>La gare de Fontenay-Tresigny est une gare de l'ancienne ligne de Paris-Bastille à Marles-en-brie. Le Plan Ile-de-France propose qu'elle soit réouverte pour la creation de la tangentielle Seine-et-Marne.</p>
</div>
<div>
<figure class="station-map-figure">
<p><a href="http://www.openstreetmap.org/?mlat=48.70850&amp;mlon=2.87107&amp;zoom=15" onclick="CommentManager.seeOnOSM('9gcn3m')" target="_blank">Voir l'emplacement de cette gare sur openstreetmap</a></p>
</figure>
</div>
<div>
