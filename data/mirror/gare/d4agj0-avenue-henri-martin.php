...
<head>
<meta charset="utf-8"/>
<title>Gare d'Avenue Henri-Martin | Le plan Ile-de-France</title>
...
<meta content="Avenue Henri-Martin" property="og:title"/>
<meta content="http://www.plidf.fr/gare/d4agj0-avenue-henri-martin.php" property="og:url"/>
<meta content="" name="description"/>
<meta content="" property="og:description"/>
<meta content="FR-75" name="geo.region"/>
<meta content="Gare d'Avenue Henri-Martin" name="geo.placename"/>
<meta content="48.86427;2.27224" name="geo.position"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="d4agj0-avenue-henri-martin.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="d4agj0-avenue-henri-martin.php">Avenue Henri-Martin</a>
</nav>
<aside id="side-box">
<div>
...
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','d4agj0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','d4agj0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','d4agj0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','d4agj0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','d4agj0');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','d4agj0');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\d4agj0.png" title="QRcode for http://www.plidf.fr/gare/d4agj0-avenue-henri-martin.php"/>
<hr/>
</div>
</div>
</aside>
...
<div id="description">
<p>La gare de l'avenue Henri Martin est une gare de la ligne de Petite-Ceinture actuellement intégrée au RER C. Le Plan Ile-de-France propose qu'elle soit desservie par la Petite Ceinture Express en plus du RER C et étendue par une station du métro Sud.</p>
</div>
<div>
<figure class="station-map-figure">
<p><a href="http://www.openstreetmap.org/?mlat=48.86427&amp;mlon=2.27224&amp;zoom=15" onclick="CommentManager.seeOnOSM('d4agj0')" target="_blank">Voir l'emplacement de cette gare sur openstreetmap</a></p>
</figure>
</div>
<div>
