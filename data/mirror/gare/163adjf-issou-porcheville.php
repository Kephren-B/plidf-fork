...
<head>
<meta charset="utf-8"/>
<title>Gare d'Issou - Porcheville | Le plan Ile-de-France</title>
...
<meta content="Issou - Porcheville" property="og:title"/>
<meta content="http://www.plidf.fr/gare/163adjf-issou-porcheville.php" property="og:url"/>
<meta content="" name="description"/>
<meta content="" property="og:description"/>
<meta content="FR-78" name="geo.region"/>
<meta content="Gare d'Issou - Porcheville" name="geo.placename"/>
<meta content="48.97943;1.78446" name="geo.position"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="163adjf-issou-porcheville.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="163adjf-issou-porcheville.php">Issou - Porcheville</a>
</nav>
<aside id="side-box">
<div>
...
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','163adjf');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','163adjf');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','163adjf');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','163adjf');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','163adjf');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','163adjf');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\163adjf.png" title="QRcode for http://www.plidf.fr/gare/163adjf-issou-porcheville.php"/>
<hr/>
</div>
</div>
</aside>
...
<em>Communes de <span class="commune-name-span">Issou</span>, <span class="commune-name-span">Porcheville</span> </em>
<div id="description">
<p>La gare d'Issou-Porcheville est une gare de la ligne de Paris-Saint-Lazare à Mantes-la-Jolie par Conflans. Le Plan Ile-de-France propose que sa desserte soit transferée du transilien J au RER F.</p>
</div>
<div>
<figure class="station-map-figure">
<p><a href="http://www.openstreetmap.org/?mlat=48.97943&amp;mlon=1.78446&amp;zoom=15" onclick="CommentManager.seeOnOSM('163adjf')" target="_blank">Voir l'emplacement de cette gare sur openstreetmap</a></p>
</figure>
</div>
<div>
