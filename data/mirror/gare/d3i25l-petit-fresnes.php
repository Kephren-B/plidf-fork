...
<head>
<meta charset="utf-8"/>
<title>Petit Fresnes (Métro) | Le plan Ile-de-France</title>
...
<meta content="Petit Fresnes" property="og:title"/>
<meta content="http://www.plidf.fr/gare/d3i25l-petit-fresnes.php" property="og:url"/>
<meta content="" name="description"/>
<meta content="" property="og:description"/>
<meta content="FR-94" name="geo.region"/>
<meta content="Petit Fresnes (Métro)" name="geo.placename"/>
<meta content="48.75664;2.32865" name="geo.position"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="d3i25l-petit-fresnes.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="d3i25l-petit-fresnes.php">Petit Fresnes</a>
</nav>
<aside id="side-box">
<div>
...
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','d3i25l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','d3i25l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','d3i25l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','d3i25l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','d3i25l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','d3i25l');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\d3i25l.png" title="QRcode for http://www.plidf.fr/gare/d3i25l-petit-fresnes.php"/>
<hr/>
</div>
</div>
</aside>
...
<em>Commune de <span class="commune-name-span">Fresnes</span> </em>
<div id="description">
<p>La station Petit Fresnes est un projet de station de la ligne 4 pour desservir la commune de Fresnes et en correspondance avec le TVM.</p>
</div>
<div>
<figure class="station-map-figure">
<p><a href="http://www.openstreetmap.org/?mlat=48.75664&amp;mlon=2.32865&amp;zoom=15" onclick="CommentManager.seeOnOSM('d3i25l')" target="_blank">Voir l'emplacement de cette gare sur openstreetmap</a></p>
</figure>
</div>
<div>
