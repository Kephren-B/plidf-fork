...
<head>
     <meta charset="utf-8" />
     <title>Soutenez notre initiative</title>
     <meta content="width=device-width, initial-scale=1.0" name="viewport" />
     <meta content="website" property="og:type" />
     <meta content="Plan Ile-de-France" property="og:site_name" />
     <meta content="Soutenez notre initiative" property="og:title" />
     <meta content="http://www.plidf.fr/dons.php" property="og:url" />
     <meta content="Faites un don pour soutenir l'initiative Le Plan Ile-de-France" name="description" />
     <meta content="Faites un don pour soutenir l'initiative Le Plan Ile-de-France" property="og:description" />
     <link href="layouts\main\css\layout.css" rel="stylesheet" />
     <link href="layouts\main\css\graphics.css" rel="stylesheet" />
     <link href="dons.php" rel="canonical" />
     ...
     <div id="all">
          ...
          <main>
               <nav id="breadcrumb">
                    ...
                    <a href="page\dons\index.html">Faire un don</a>
               </nav>
               <aside id="side-box">
               </aside>
               <article class="node-list-slot">
                    <div>
                         <div>
                              <h1>Faire un don pour soutenir le plan Ile-de-France</h1>
                              <p> Nous menons des operations de communication pour défendre nos idées. Si nos propositions vous ont plu pensez à nous soutenir financièrement. </p>
                              <dl>
                                   <dt>
                                        Faire un don à l'association PLIDF
                                   </dt>
                                   <dd style="padding:20px;text-align:center;">
                                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                             <input name="cmd" type="hidden" value="_s-xclick" />
                                             <input name="hosted_button_id" type="hidden" value="V3UELE5MN52AN" />
                                             <input alt="PayPal, le réflexe sécurité pour payer en ligne" border="0" name="submit" src="/plan-ile-de-france/medias/buttons/paypal.png" type="image" />
                                             <img alt="" border="0" height="1" src="fr_FR\i\scr\pixel.gif" width="1" />
                                        </form>
                                   </dd>
                              </dl>
                         </div>
