...
<body>
        ...
        <tbody>
          <tr>
            ...
            <td class="panel panel-info panel-commune">
              ...
              <div class="panel-body">
                2 projets et 1 station. Découvrez ce qui est prévu pour la <a href="commune\Mareuil-les-Meaux.php" target="_blank">commune de Mareuil-les-Meaux</a> dans le plan Île-de-France. </div>
            </td>
          </tr>
          <tr>
  ...
  <script>
    ...
    var refreshHomeInterval = window.setInterval(function() {
      refreshHome()
    }, refreshDelay);
