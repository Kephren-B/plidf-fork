...
<head>
<meta charset="utf-8"/>
<title>Metro v | Le plan Ile-de-France</title>
...
<meta content="Metro v" property="og:title"/>
<meta content="http://www.plidf.fr/ligne/m_v.php" property="og:url"/>
<meta content="La ligne m v est un projet de liaison entre Buc et Bougival via Versailles et le Chesnay. Cette ligne de métro serait un métro léger de type VAL." name="description"/>
<meta content="La ligne m v est un projet de liaison entre Buc et Bougival via Versailles et le Chesnay. Cette ligne de métro serait un métro léger de type VAL." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="m_v.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="m_v.php">Metro v</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\m_v.png" title="QRcode for http://www.plidf.fr/ligne/m_v.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','117hmnl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','117hmnl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','117hmnl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','117hmnl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','117hmnl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','117hmnl');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Liaison Buc - Bougival</h1>
<p><em>Buc ZA - Bougival-Ile-de-la-Chaussée</em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>La ligne m v est un projet de liaison entre Buc et Bougival via Versailles et le Chesnay. Cette ligne de métro serait un métro léger de type VAL.</p>
</div>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\liaison_buc_-_bougival.jpg" onclick="CommentManager.reportMap('liaison_buc_-_bougival','117hmnl')"><img src="..\medias\plans\liaison_buc_-_bougival_resized.jpg" style="max-width:450px" title="Carte de la ligne Cliquer pour agrandir."/></a>
<figcaption>
         Carte de la ligne
         <br/>
...
<dt>
<a href="..\prol\7km5bg-liaison-buc-bougival.php" title="Voir le détail de ce projet (tracé et stations)">Liaison Buc - Bougival</a>
</dt>
<dd>
         Voir le détail du tracé et la liste des stations.
        </dd>
</dl>
<pre>
