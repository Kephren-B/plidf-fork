...
<head>
<meta charset="utf-8"/>
<title>Metro 5 | Le plan Ile-de-France</title>
...
<meta content="Metro 5" property="og:title"/>
<meta content="http://www.plidf.fr/ligne/m_5.php" property="og:url"/>
<meta content="La ligne 5 du métro francilien et les propositions d'extensions envisagées dans le cadre du plan Île-de-France." name="description"/>
<meta content="La ligne 5 du métro francilien et les propositions d'extensions envisagées dans le cadre du plan Île-de-France." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="m_5.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="m_5.php">Metro 5</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\m_5.png" title="QRcode for http://www.plidf.fr/ligne/m_5.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','i175ae');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','i175ae');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','i175ae');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','i175ae');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','i175ae');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','i175ae');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Métro 5</h1>
<p><em>(Villepinte) Bobigny-Pablo Picasso - Place d'Italie (Châtillon - Montrouge) </em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>La ligne 5 du métro est une ligne de métro qui traverse Paris suivant un axe nord-sud. Bien que la ligne desserve la gare du Nord, République et la gare d'Austerlitz, elle reste relativement peu fréquentée comparée à la ligne 4.</p>
<p>Le Plan Ile de France propose de prolonger la ligne au Nord jusqu'au parc des expositions de Villepinte en passant par Drancy, le Blanc-Ménil et Aulnay-sous-Bois.</p>
<p>Au sud, le STIF envisage l'extension de la ligne jusqu'à la place de Rungis dans le XIIIe arrondissement de Paris, le Plan Ile-de-France propose de l'étendre jusqu'à <a href="..\gare\18kga98-chatillon-montrouge.php">Châtillon - Montrouge</a> pour améliorer le maillage du réseau de métro et de RER au sud de Paris.</p>
</div>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\schema_m_5.png" onclick="CommentManager.reportMap('schema_m_5.png','i175ae')"><img src="..\medias\plans\schema_m_5.png" style="max-width:450px" title="Schéma de la ligne avec ses extensions. Cliquer pour agrandir."/></a>
<figcaption>
...
<dt>
<a href="..\prol\a53ghg-m5-nord-bobigny-villepinte.php" title="Voir le détail de ce projet (tracé et stations)">M5 Nord - Villepinte</a>
</dt>
<dd>
         Voir le tracé de l'extension de la ligne 5 vers Drancy, Le Blanc-Mesnil et le Parc des expositions. 
        </dd>
<dt>
<a href="..\prol\13c6cl9-m5-sud-italie-chatillon.php" title="Voir le détail de ce projet (tracé et stations)">M5 Sud - Châtillon</a>
</dt>
<dd>
         Voir le détail de l'extension de la ligne vers le sud vers cité universitaire et Châtillon-Montrouge.
        </dd>
</dl>
