...
<head>
<meta charset="utf-8"/>
<title>t 3b | Le plan Ile-de-France</title>
...
<meta content="t 3b" property="og:title"/>
<meta content="http://www.plidf.fr/ligne/t_3b.php" property="og:url"/>
<meta content="La ligne 3b du tramway est la partie nord du tramway circulaire de Paris." name="description"/>
<meta content="La ligne 3b du tramway est la partie nord du tramway circulaire de Paris." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="t_3b.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="t_3b.php">t 3b</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\t_3b.png" title="QRcode for http://www.plidf.fr/ligne/t_3b.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','15amhkc');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','15amhkc');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','15amhkc');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','15amhkc');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','15amhkc');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','15amhkc');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Tramway T 3b</h1>
<p><em>Porte de Vincennes - Porte de la Chapelle (Porte d'Asnières)</em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>La ligne 3b constitue la partie nord du tramway des Maréchaux qui remplace le bus PC. Il est en cours de prolongement vers la porte d'Asnières et une extension au moins jusqu'à porte Dauphine est à l'étude.</p>
</div>
...
<dd>
         La petite ceinture express est un projet de nouvelle ligne équivalente à la ligne circle de Londres pour faire le tour de Paris plus vite qu'en voiture sur le boulevard périphérique.
        </dd>
</dl>
