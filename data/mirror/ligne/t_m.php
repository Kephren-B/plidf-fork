...
<head>
<meta charset="utf-8"/>
<title>t m | Le plan Ile-de-France</title>
...
<meta content="t m" property="og:title"/>
<meta content="http://www.plidf.fr/ligne/t_m.php" property="og:url"/>
<meta content="Le tram-train de Melun est une proposition du Plan Ile-de-France. Il consisterait en un tramway qui ferait le tour de l'agglomération meulane et passerait par la gare principale de Melun." name="description"/>
<meta content="Le tram-train de Melun est une proposition du Plan Ile-de-France. Il consisterait en un tramway qui ferait le tour de l'agglomération meulane et passerait par la gare principale de Melun." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="t_m.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="t_m.php">t m</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\t_m.png" title="QRcode for http://www.plidf.fr/ligne/t_m.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','12ik9nl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','12ik9nl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','12ik9nl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','12ik9nl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','12ik9nl');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','12ik9nl');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Tram-train de Melun</h1>
<p><em>Livry-sur-Seine - Dammarie-lès-Lys</em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>Le tram-train de Melun est une idée de tramway qui ferait le tour de l'agglomération meulane pour la connecter à sa gare principale qui est excentrée vers le sud. La moitié ouest de son tracé serait partagé avec la tangentielle Seine-et-Marne.</p>
</div>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\melun_tg_tt.jpg" onclick="CommentManager.reportMap('melun_tg_tt','12ik9nl')"><img src="..\medias\plans\melun_tg_tt_resized.jpg" style="max-width:450px" title="En vert, le tracé complet de la ligne. Cliquer pour agrandir."/></a>
<figcaption>
         En vert, le tracé complet de la ligne.
         <br/>
...
<dd>
         Voir le détail du tracé avec les stations et les correspondances.
        </dd>
</dl>
<pre>
