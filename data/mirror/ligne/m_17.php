...
<head>
<meta charset="utf-8"/>
<title>Metro 17 | Le plan Ile-de-France</title>
...
<meta content="Metro 17" property="og:title"/>
<meta content="http://www.plidf.fr/ligne/m_17.php" property="og:url"/>
<meta content="La ligne 17 du métro francilien et les propositions d'extensions envisagées dans le cadre du plan Île-de-France." name="description"/>
<meta content="La ligne 17 du métro francilien et les propositions d'extensions envisagées dans le cadre du plan Île-de-France." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="m_17.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="m_17.php">Metro 17</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\m_17.png" title="QRcode for http://www.plidf.fr/ligne/m_17.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','fl51d8');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','fl51d8');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','fl51d8');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','fl51d8');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','fl51d8');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','fl51d8');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Métro 17</h1>
<p><em>Saint-Denis-Pleyel - Aéroport Charles-de-Gaulle</em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>La ligne 17 est une ligne de métro envisagée pour desservir Gonesse et l'aéroport de Roissy. Le Plan-Ile-de-France propose de faire passer la ligne à l'ouest de l'aéroport du Bourget suivant un tracé qui correspond à la ligne de bus 250 de la RATP.</p>
</div>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\m17_complet.jpg" onclick="CommentManager.reportMap('m17_complet','fl51d8')"><img src="..\medias\plans\m17_complet_resized.jpg" style="max-width:450px" title="Tracé de la ligne 17. Cliquer pour agrandir."/></a>
<figcaption>
         Tracé de la ligne 17.
         <br/>
...
<dt>
<a href="..\prol\mk5115-m17-pleyel-roissy.php" title="Voir le détail de ce projet (tracé et stations)">M17 Pleyel - Roissy</a>
</dt>
<dd>
         Tracé détaillé de la ligne 17 tel que proposé par le Plan Ile-de-France.
        </dd>
</dl>
<pre>
