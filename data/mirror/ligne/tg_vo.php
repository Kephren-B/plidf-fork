...
<meta content="http://www.plidf.fr/ligne/tg_vo.php" property="og:url"/>
<meta content="La tangentielle Val-d'Oise est une proposition du Plan Ile-de-France pour mieux relier le Val-d'Oise à l'aéroport de Roissy et à la Seine-et-Marne. " name="description"/>
<meta content="La tangentielle Val-d'Oise est une proposition du Plan Ile-de-France pour mieux relier le Val-d'Oise à l'aéroport de Roissy et à la Seine-et-Marne. " property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="tg_vo.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="tg_vo.php">Tangentielle Val-d'Oise</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\tg_vo.png" title="QRcode for http://www.plidf.fr/ligne/tg_vo.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','kmd13l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','kmd13l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','kmd13l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','kmd13l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','kmd13l');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','kmd13l');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Tangentielle Val-d'Oise</h1>
<p><em>Mantes-la-Jolie / Conflans - Claye-Souilly / Meaux</em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>La tangentielle Val d'Oise est une proposition du Plan Ile-de-France pour relier les principaux pôle du département du Val-d'Oise. Elle permettra d'assurer une liaison entre Mantes-la-Jolie, Pontoise et Roissy. En partant de Mantes, les trains pourront emprunter l'une des deux lignes qui remontent la vallée de la Seine pour arriver à <a href="..\gare\eggnif-conflans-fin-doise.php">Conflans-Fin-d'Oise</a> puis à <a href="..\gare\d6g61g-eragny-neuville.php">Eragny - Neuville</a>. Le tracé emprunterait ensuite le raccordement de Saint-Ouen-l'Aumône sur lequel une <a href="..\gare\6h6c28-saint-ouen-laumone-za.php">une gare</a> serait créée pour desservir la zone d'activité. Un saut de mouton devra être aménagé pour le croisement avec la ligne de Saint-Denis à Dieppe pour atteindre <a href="..\gare\a749fm-epluches.php">Épluches</a>.</p>
<p>Le trajet utiliserait ensuite la ligne de Pontoise à Creil jusqu'à Parmain et une nouvelle ligne à travers la forêt de l'Isle-Adam permettra d'atteindre Presles pour ensuite rejoindre <a href="..\gare\n4mc1j-monsoult-maffliers.php">Monsoult-Mafliers</a>.</p>
...
<p>La tangentielle Val-d'Oise ouvre la possibilité de créer des liaisons TER Normandie - Roissy et de faire de la gare d'Épluches une gare grandes lignes (TER et TGV) pour la desserte de l'agglomération de Cergy - Pontoise à laquelle elle sera reliée par la <a href="cv_2.php">ligne 2 du Cergyval</a>.</p>
</div>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\tg_vo_complet.jpg" onclick="CommentManager.reportMap('tg_vo_complet','kmd13l')"><img src="..\medias\plans\tg_vo_complet_resized.jpg" style="max-width:450px" title="Tracé complet de la tangentielle. Cliquer pour agrandir."/></a>
<figcaption>
         Tracé complet de la tangentielle.
         <br/>
...
<dt>
<a href="..\prol\18mgkla-tangentielle-val-doise.php" title="Voir le détail de ce projet (tracé et stations)">Tangentielle Val-d'Oise</a>
</dt>
<dd>
         Voir le tracé détaillé de la tangnetielle avec la liste des stations et des correspondances.
        </dd>
</dl>
<pre>
