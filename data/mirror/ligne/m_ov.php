...
<head>
<meta charset="utf-8"/>
<title>Metro ov | Le plan Ile-de-France</title>
...
<meta content="Metro ov" property="og:title"/>
<meta content="http://www.plidf.fr/ligne/m_ov.php" property="og:url"/>
<meta content="La ligne Orlyval qui relie la gare d'Antony à l'aéroport d'Orly. Le Plan Ile-de-France propose de l'étendre à l'est et à l'ouest, d'ajouter trois stations sur la partie centrale pour faire de l'orlyval une ligne de métro de rocade pour la banlieue sud de Paris." name="description"/>
<meta content="La ligne Orlyval qui relie la gare d'Antony à l'aéroport d'Orly. Le Plan Ile-de-France propose de l'étendre à l'est et à l'ouest, d'ajouter trois stations sur la partie centrale pour faire de l'orlyval une ligne de métro de rocade pour la banlieue sud de Paris." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="m_ov.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="m_ov.php">Metro ov</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\m_ov.png" title="QRcode for http://www.plidf.fr/ligne/m_ov.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','10lnk5f');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','10lnk5f');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','10lnk5f');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','10lnk5f');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','10lnk5f');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','10lnk5f');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Orlyval</h1>
<p><em>(La Butte Rouge) Antony - Orly-Sud (Valenton)</em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>La ligne Orlyval est une courte ligne de VAL qui relie la gare d'Antony à l'aéroport d'Orly sans arrêts intermédiaires. Elle a été construite pour mieux relier l'aéroport d'Orly à Paris. Elle perdra son rôle de desserte de l'aéroport d'Orly avec l'extension de la <a href="m_14.php">ligne 14</a> et la création du <a href="rer_f.php">RER F</a>. Nous proposons de faire de cette ligne de VAL un ligne de métro de rocade en la prolongeant à ses deux extrémités et en ajoutant trois stations sur la partie existante: Orly TGV, Wissous et Chemin d'Antony. La portion <a href="..\gare\15ba141-orly-tgv.php">Orly TGV</a> - <a href="..\gare\fcdcad-chemin-dantony.php">Chemin d'Antony</a> serait éventuellement partagée avec la <a href="m_18.php">ligne 18 du métro</a>.</p>
</div>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\m_ov_complet.jpg" onclick="CommentManager.reportMap('m_ov_complet','10lnk5f')"><img src="..\medias\plans\m_ov_complet_resized.jpg" style="max-width:450px" title="Tracé complet du val prolongé avec les stations ajoutées sur le tronc central. Cliquer pour agrandir."/></a>
<figcaption>
         Tracé complet du val prolongé avec les stations ajoutées sur le tronc central.
         <br/>
...
<dt>
<a href="..\prol\ch779a-grand-orlyval.php" title="Voir le détail de ce projet (tracé et stations)">Grand Orlyval</a>
</dt>
<dd>
         Voir le détail du tracé de l'Orlyval étendu.
        </dd>
</dl>
<pre>
