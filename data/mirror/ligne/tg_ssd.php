...
<meta content="http://www.plidf.fr/ligne/tg_ssd.php" property="og:url"/>
<meta content="La tangentielle Seine-Saint-Denis est un projet de liaison tangentielle de la banlieue Nord de Paris. Une première partie entre le Bourget et Épinay-sur-Seine est actuellement en cours de construction. Le Plan Ile-de-France propose de faire ce service aller de Poissy à Chelles-Gournay." name="description"/>
<meta content="La tangentielle Seine-Saint-Denis est un projet de liaison tangentielle de la banlieue Nord de Paris. Une première partie entre le Bourget et Épinay-sur-Seine est actuellement en cours de construction. Le Plan Ile-de-France propose de faire ce service aller de Poissy à Chelles-Gournay." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="tg_ssd.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="tg_ssd.php">Tangentielle Seine-Saint-Denis</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\tg_ssd.png" title="QRcode for http://www.plidf.fr/ligne/tg_ssd.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','f5j596');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','f5j596');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','f5j596');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','f5j596');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','f5j596');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','f5j596');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Tangentielle Seine-Saint-Denis</h1>
<p><em>Chelles-Gournay - Poissy</em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>La tangentielle Seine-Saint-Denis est un projet de réouverture au service voyageurs de la ligne de Grande Ceinture. Déjà planifiée par STIF en tant que tangentielle nord et actuellement en construction entre le Bourget et Épinay-sur-Seine, cette tangentielle serait étendue jusqu'à Poissy à l'ouest (correspondance avec le Cergyval et la tangentielle Yvelines) et Chelles-Gournay à l'est. (Correspondance Tangentielle Val-de-Marne et RER G). Elle formerait alors un système de rocade de moyenne banlieue en complément de la <a href="m_16.php">ligne 16</a> du métro.</p>
</div>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\tg_ssd_complet.jpg" onclick="CommentManager.reportMap('tg_ssd_complet','f5j596')"><img src="..\medias\plans\tg_ssd_complet_resized.jpg" style="max-width:450px" title="Tracé complet de la ligne. Cliquer pour agrandir."/></a>
<figcaption>
...
<dt>
<a href="..\prol\194083n-tangentielle-seine-saint-denis.php" title="Voir le détail de ce projet (tracé et stations)">Tangentielle Seine-Saint-Denis</a>
</dt>
<dd>
         Voir le tracé détaillé de la tangentielle.
        </dd>
</dl>
<pre>
