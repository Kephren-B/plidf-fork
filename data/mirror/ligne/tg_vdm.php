...
<meta content="http://www.plidf.fr/ligne/tg_vdm.php" property="og:url"/>
<meta content="La tangentielle Val-de-Marne est la proposition de réouvrir au trafic voyageur la partie est de la ligne de Grande Ceinture de Paris. Elle permettrait de mieux relier le Val de Marne à Massy-Palaiseau et l'aéroport d'Orly." name="description"/>
<meta content="La tangentielle Val-de-Marne est la proposition de réouvrir au trafic voyageur la partie est de la ligne de Grande Ceinture de Paris. Elle permettrait de mieux relier le Val de Marne à Massy-Palaiseau et l'aéroport d'Orly." property="og:description"/>
<link href="..\layouts\main\css\layout.css" rel="stylesheet"/>
<link href="..\layouts\main\css\graphics.css" rel="stylesheet"/>
<link href="tg_vdm.php" rel="canonical"/>
...
<a href="..\index.php">Accueil</a> &gt; 
     ...
     <a href="tg_vdm.php">Tangentielle Val de Marne</a>
</nav>
<aside id="side-box">
<div>
<div id="qr-div">
<hr/>
<img class="qr-code" src="..\medias\qrcodes\tg_vdm.png" title="QRcode for http://www.plidf.fr/ligne/tg_vdm.php"/>
<hr/>
</div>
</div>
<div>
<nav id="social-nav">
<h6>Partager</h6>
<span><a class="social-link" href="..\sharer.php" onclick="CommentManager.reportShared('Facebook','12jnji2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\facebook_plidf.svg" title="Facebook"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Google ','12jnji2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\google_plus_plidf.svg" title="Google+"/></a><a class="social-link" href="..\share\index.html" onclick="CommentManager.reportShared('Twitter','12jnji2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\twitter_plidf.svg" title="Twitter"/></a><a class="social-link" href="..\shareArticle\index.html" onclick="CommentManager.reportShared('Linkedin','12jnji2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\linkedin_plidf.svg" title="Linkedin"/></a><a class="social-link" href="..\pin\create\button\index.html" onclick="CommentManager.reportShared('PInterest','12jnji2');" rel="nofollow" target="_blank"><img class="social-link-img" height="32" src="..\medias\icons\pinterest_plidf.svg" title="PInterest"/></a><a class="social-link" href="..\index.html" target="_blank"><img class="social-link-img" height="32" onclick="CommentManager.reportShared('Mail','12jnji2');" src="..\medias\icons\mail_plidf.svg" title="Envoyer par mail"/></a></span>
</nav>
</div>
<div>
...
<div>
<article>
<h1 id="top">Tangentielle Val de Marne</h1>
<p><em>Chelles - Massy-Palaiseau</em></p>
<div>
<a class="section-link top-link" href="#projects-section">↓ Aller aux projets d'extension</a>
</div>
<div>
<p>La tangentielle Seine-et-Marne est une proposition du Plan Ile-de-France pour relier les gares de Chelles-Gournay et Massy-Palaiseau par la ligne de Grande Ceinture réouverte au trafic voyageurs. Le tracé utiliserait la ligne de grande ceinture complémentaire. Il passerait par la branche ouest du triangle de Gagny puis desservirait Neuilly, Bry, Champigny et Chennevières-sur-Marne. Des correspondances avec le RER A sont possible à Bry-sur-Marne et à Sucy-Bonneuil. Le tracé continuerait ensuite vers Valenton, Orly-Ville et Pont de Rungis.</p>
<p>À Pont de Rungis, un remaniement de la desserte serait effectue: les trains de la tangentielle continueraient vers Massy-Palaiseau par <a href="..\gare\fcdcad-chemin-dantony.php">Chemin d'Antony</a> tandis que les trains du RER C <a href="..\prol\11d9i70-rerc-remaniement-orly.php">passeraient par Orly TGV</a> en partageant les l'infrastructures du <a href="..\prol\82636i-rerf-tronc-commun.php">tronc commun du RER F</a> entre Pont de Rungis et Chilly-Mazarin.</p>
</div>
<h2 id="maps-section">Carte</h2>
<figure>
<a class="big-map-link" href="..\medias\plans\tg_vdm_complet.jpg" onclick="CommentManager.reportMap('tg_vdm_complet','12jnji2')"><img src="..\medias\plans\tg_vdm_complet_resized.jpg" style="max-width:450px" title="Tracé complet de la tangentielle. Cliquer pour agrandir."/></a>
<figcaption>
...
<dd>
         Voir le tracé détaillé de la tangentielle avec la liste des stations.
        </dd>
</dl>
<pre>
